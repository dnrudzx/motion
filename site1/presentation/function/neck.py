#import keypoint_all as kp
from . import keypoint_all as kp
import numpy as np
import cv2
import math
...
def head_point_out(tooH, tooL, ok):
    ...
    for i in range(len(tooH)+len(tooL)+len(ok)):
    	...
    	path = ('/home/ms/openpose/build/examples/tutorial_api_python/site1/media/output/frame/frame_3'+ str(i) +'.jpg')
