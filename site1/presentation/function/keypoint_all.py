...
def keypoint(num, point):
    if str(num) == "1":
        frame_path = "/home/ms/openpose/build/examples/tutorial_api_python/site1/media/output/based_frame/frame_3"
        array_path = "/home/ms/openpose/build/examples/tutorial_api_python/site1/media/output/based_array/array_3"
    elif str(num) == "2":
        frame_path = "/home/ms/openpose/build/examples/tutorial_api_python/site1/media/output/frame/frame_3"
        array_path = "/home/ms/openpose/build/examples/tutorial_api_python/site1/media/output/array/array_3"
