...
cap = cv2.VideoCapture("/home/ms/pushR.avi")

#save
#fourcc = cv2.VideoWriter_fourcc(*'XVID')
#out = cv2.VideoWriter('pushRT.avi', fourcc, 25.0, (int(cap.get(3)),int(cap.get(4))))
...
while(cap.isOpened()):
    ...
    #np.save("./test/array_1%d" % count, datum.poseKeypoints)
    #cv2.imwrite("./frame/frame_1%d.jpg"%count, datum.cvOutputData)
    #count += 1
